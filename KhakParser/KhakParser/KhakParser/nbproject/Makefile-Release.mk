...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/khakparser: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/khakparser ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/5c0/CKhHttpL.o: ../CKhHttpL.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/CKhHttpL.o ../CKhHttpL.cpp

${OBJECTDIR}/_ext/5c0/CKhParser.o: ../CKhParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/CKhParser.o ../CKhParser.cpp

${OBJECTDIR}/_ext/5c0/CKhParserELAN.o: ../CKhParserELAN.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/CKhParserELAN.o ../CKhParserELAN.cpp
